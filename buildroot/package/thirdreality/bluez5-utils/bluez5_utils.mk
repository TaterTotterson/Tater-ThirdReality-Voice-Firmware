...
BLUEZ5_UTILS_SITE = $(TOPDIR)/package/thirdreality/bluez5-utils/src
...
ifeq ($(BR2_PACKAGE_REALTEK_BT),y)
Device=rtk
else ifeq ($(BR2_PACKAGE_QUALCOMM_WIFI),y)
Device=qca
else ifeq ($(BR2_PACKAGE_AML_BT),y)
Device=aml
DeviceID=bluetooth:8888:0000
else ifeq ($(BR2_PACKAGE_BROADCOM),y)
Device=bcm
